...
public class SourceData {
    ...
    public PlanarYUVLuminanceSource createSource() {
        ...
        if (isRotated()) {
            width = width == -1 ? dataHeight : width;
            height = height == -1 ? dataWidth : height;
            //noinspection SuspiciousNameCombination
            return new PlanarYUVLuminanceSource(rotated, dataHeight, dataWidth, left, top, width, height, false);
        } else {
            width = width == -1 ? dataWidth : width;
            height = height == -1 ? dataHeight : height;
            return new PlanarYUVLuminanceSource(rotated, dataWidth, dataHeight, left, top, width, height, false);
        }
    }
