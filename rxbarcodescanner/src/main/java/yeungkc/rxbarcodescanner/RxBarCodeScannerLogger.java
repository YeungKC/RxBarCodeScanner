 ...
 */
public final class RxBarCodeScannerLogger {
    ...
    static RxBarCodeScannerLogger create(String tag) {
        return new RxBarCodeScannerLogger(tag);
    }
    ...
    private RxBarCodeScannerLogger(String tag) {
        mTag = tag;
    }
