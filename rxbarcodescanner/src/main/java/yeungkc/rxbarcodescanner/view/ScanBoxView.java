package yeungkc.rxbarcodescanner.view;
...
import yeungkc.rxbarcodescanner.R;
...
public class ScanBoxView extends View {
    ...
    public ScanBoxView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRectWidth = dp2px(context, 200);
        mCustomScanLineDrawable = null;
        mScanLineBitmap = null;
        mBorderSize = dp2px(context, 1);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.ScanBoxView_topOffset) {
            mTopOffset = typedArray.getDimensionPixelSize(attr, 0);
        } else if (attr == R.styleable.ScanBoxView_cornerSize) {
        ...
        } else if (attr == R.styleable.ScanBoxView_rectWidth) {
        ...
        } else if (attr == R.styleable.ScanBoxView_isCenterVertical) {
            mIsCenterVertical = typedArray.getBoolean(attr, false);
        } else if (attr == R.styleable.ScanBoxView_customGridScanLineDrawable) {
            mCustomGridScanLineDrawable = typedArray.getDrawable(attr);
        } else if (attr == R.styleable.ScanBoxView_toolbarHeight) {
    ...
    private void afterInitCustomAttrs() {
        ...
        if (mOriginQRCodeGridScanLineBitmap == null) mCustomGridScanLineDrawable = null;
        ...
        if (mOriginQRCodeScanLineBitmap == null) mCustomScanLineDrawable = null;
